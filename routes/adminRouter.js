...
router.put('/updateProduct/:id', adminAuth, upload.array('images', 5), productController.updateProduct);
router.delete('/deleteProduct/:id', adminAuth, productController.deleteProduct);
router.delete('/removeProductImage/:productId/:imageIndex', adminAuth, productController.removeProductImage);
router.put('/replaceProductImage/:productId/:imageIndex', adminAuth, upload.single('image'), productController.replaceProductImage);
